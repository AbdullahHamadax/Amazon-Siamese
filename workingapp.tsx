          ...
          <div className="relative bg-slate-900 border border-slate-800 rounded-xl p-6 flex flex-col gap-6 shadow-2xl">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center pt-4 border-t border-slate-800 gap-4">
              ...
              <button
                ...
                disabled={loading}
                className="bg-cyan-600 hover:bg-cyan-500 text-white border border-cyan-400 px-8 py-3 rounded shadow-[0_0_15px_rgba(6,182,212,0.4)] text-sm font-bold tracking-wider flex items-center gap-2 transition-all disabled:opacity-50 disabled:shadow-none"
              >
                {loading ? (
                  "ANALYZING..."
                ) : (
                  <>
                    INITIATE SEARCH <ArrowRight size={16} />
                  </>
                )}
              </button>
            </div>
